...
L_UnequipWindowFunction* UnequipWindow;
L_ReserveTexture2DFunction* ReserveTexture2D;
L_ReleaseTexture2DFunction* ReleaseTexture2D;
L_FillTexture2DFunction* FillTexture2D;
L_SizeFromTexture2DFunction* SizeFromTexture2D;
L_StartFunction* Start;
L_Submit2DFunction* Submit2D;
L_FinishFunction* Finish;
};
...
typedef struct UnequipWindowStruct UnequipWindowStruct;
    struct UnequipWindowStruct
    {
...
typedef struct ReserveTexture2DStruct ReserveTexture2DStruct;
    struct ReserveTexture2DStruct
    {
...
typedef struct ReleaseTexture2DStruct ReleaseTexture2DStruct;
    struct ReleaseTexture2DStruct
    {
...
typedef struct FillTexture2DStruct FillTexture2DStruct;
    struct FillTexture2DStruct
    {
...
typedef struct SizeFromTexture2DStruct SizeFromTexture2DStruct;
    struct SizeFromTexture2DStruct
    {
    R_SizeFromTexture2DFunction* SizeFromTexture2D; 
r_handle TEXTURE;
    }

typedef struct StartStruct StartStruct;
    struct StartStruct
    {
...
typedef struct Submit2DStruct Submit2DStruct;
    struct Submit2DStruct
    {
...
typedef struct FinishStruct FinishStruct;
    struct FinishStruct
    {
...
readonly global char* myenum_string_table[] =
{
"A",
"B",
"C",
...
R_Handle  R_ReserveTexture2D(R_Handle os_eqp, Vec2S64 size, R_Texture2DFormat fmt);
void      R_ReleaseTexture2D(R_Handle os_eqp, R_Handle texture);
void      R_FillTexture2D(R_Handle os_eqp, R_Handle texture, Rng2S64 subrect, String8 data);
Vec2F32   R_SizeFromTexture2D(R_Handle texture);
void      R_Start(R_Handle os_eqp, R_Handle window_eqp, Vec2S64 resolution);
void      R_Submit2D(R_Handle os_eqp, R_Handle window_eqp, R2_CmdList commands);
...
void      R_UnequipWindowStub(R_Handle os_eqp, R_Handle window_eqp);
R_Handle  R_ReserveTexture2DStub(R_Handle os_eqp, Vec2S64 size, R_Texture2DFormat fmt);
void      R_ReleaseTexture2DStub(R_Handle os_eqp, R_Handle texture);
void      R_FillTexture2DStub(R_Handle os_eqp, R_Handle texture, Rng2S64 subrect, String8 data);
Vec2F32   R_SizeFromTexture2DStub(R_Handle texture);
void      R_StartStub(R_Handle os_eqp, R_Handle window_eqp, Vec2S64 resolution);
void      R_Submit2DStub(R_Handle os_eqp, R_Handle window_eqp, R2_CmdList commands);
void      R_FinishStub(R_Handle os_eqp, R_Handle window_eqp);
...
typedef void     R_Submit2DFunction(R_Handle os_eqp, R_Handle window_eqp, R2_CmdList commands);
